...
if(isset($_POST['Upload_Movie'])) {
    ...
    $sql = "UPDATE movies SET description='$movie_description', movie_picture='$target_file' WHERE movie_name='$movie_name'";
...
<?php include 'assets/php/nav.php'; ?>
    ...
    <div class="container">
        ...
        <div class="head_text"><b>Update Management Page</b></div>


        <form action="#" method="post" enctype="multipart/form-data">

            <label for="movie_name">Movie Name:</label>
            <input type="text" id="movie_name" name="movie_name" required value="">
